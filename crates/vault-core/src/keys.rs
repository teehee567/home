...
pub struct SecretBuffer(SecretBox<[u8; SUBKEY_LEN]>);

impl SecretBuffer {
    pub fn expose_secret(&self) -> &[u8; SUBKEY_LEN] {
        self.0.expose_secret()
    }
}

pub fn derive_subkey(ikm: &[u8], salt: &[u8], context_string: &str) -> SecretBuffer {
